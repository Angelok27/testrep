...
/*
  *ф-ия main: главная, она будет выполнена первой
*/
int main(int argc, char *argv[]) 
{
    ...
    general_windows = GTK_WIDGET(gtk_builder_get_object(builder, "general_windows"));
    level_windows = GTK_WIDGET(gtk_builder_get_object(builder, "level_windows"));
    ...
    Hidden_Wor_Lab = GTK_LABEL(gtk_builder_get_object(builder, "Hidden_Wor_Lab"));
